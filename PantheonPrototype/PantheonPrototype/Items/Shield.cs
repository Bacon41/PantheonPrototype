...
namespace PantheonPrototype
{
    ...
    class Shield : Item
    {
            ...
            : base(contentManager.Load<Texture2D>("Sprites/Shield"))
        {
            ...
            energyField = new Entity(Vector2.Zero, new Rectangle(0, 0, 200, 200), new Rectangle(20, 20, 160, 160));
        ...
        public override void Update(GameTime gameTime, Pantheon gameReference)
        {
            ...
            if (shieldOn && currentShield > 0)
            {
                ...
                energyField.Location = new Vector2(gameReference.player.DrawingBox.X + gameReference.player.DrawingBox.Width/2, gameReference.player.DrawingBox.Y + gameReference.player.DrawingBox.Height/2);
